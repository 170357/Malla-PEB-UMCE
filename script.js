document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateCourseStates() {
        document.querySelectorAll('.course').forEach(courseElement => {
            ...
            if (courseMention !== 'TODAS' && courseMention !== selectedMention) {
            courseElement.remove(); // Eliminar completamente del DOM
            return;
        }
    ...
    mentionSelect.addEventListener('change', (event) => {
        ...
        saveProgress();
        initializeCourseMap(); // reconstruir malla completa
        updateCourseStates();  // aplicar visibilidad y estados
    });
